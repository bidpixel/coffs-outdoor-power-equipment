<section class="trust-bar" aria-label="Key credentials">
	<div class="container">
		<div class="trust-bar__inner">
			...
			<span class="trust-bar__divider" aria-hidden="true">·</span>
			<span class="trust-bar__item"><?php echo esc_html( get_theme_mod( 'hp_trust_3', 'Two Coffs Coast locations' ) ); ?></span>
			<span class="trust-bar__divider" aria-hidden="true">·</span>
			<span class="trust-bar__item"><?php echo esc_html( get_theme_mod( 'hp_trust_4', 'On-site workshop & repairs' ) ); ?></span>
		</div>
	</div>
</section>
